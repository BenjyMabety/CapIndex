...
insert into CAP_STATE values (10,'Wisconsin', 'WI',1);
...
insert into CAP_INDEX (INDEX_ID,INDEX_CITY_NAME,INDEX_STATE_ID,INDEX_PRICE_USD,INDEX_PRICE_ZAR,INDEX_SURCHARGE_PERCENTAGE,INDEX_SURCHARGE_LIMIT,INDEX_BANK_ID) VALUES (5,'San Francisco',3,5.21,96.39,10,500,5);
insert into CAP_INDEX (INDEX_ID,INDEX_CITY_NAME,INDEX_STATE_ID,INDEX_PRICE_USD,INDEX_PRICE_ZAR,INDEX_SURCHARGE_PERCENTAGE,INDEX_SURCHARGE_LIMIT,INDEX_BANK_ID) VALUES (6,'Riverside',3,3.88,71.78,5,300,6);
insert into CAP_INDEX (INDEX_ID,INDEX_CITY_NAME,INDEX_STATE_ID,INDEX_PRICE_USD,INDEX_PRICE_ZAR,INDEX_SURCHARGE_PERCENTAGE,INDEX_SURCHARGE_LIMIT,INDEX_BANK_ID) VALUES (7,'Cincinnati',8,3.95,73.08,5,300,7);
insert into CAP_INDEX (INDEX_ID,INDEX_CITY_NAME,INDEX_STATE_ID,INDEX_PRICE_USD,INDEX_PRICE_ZAR,INDEX_SURCHARGE_PERCENTAGE,INDEX_SURCHARGE_LIMIT,INDEX_BANK_ID) VALUES (8,'Pittsburgh',9,4.12,76.22,5,300,8);
insert into CAP_INDEX (INDEX_ID,INDEX_CITY_NAME,INDEX_STATE_ID,INDEX_PRICE_USD,INDEX_PRICE_ZAR,INDEX_SURCHARGE_PERCENTAGE,INDEX_SURCHARGE_LIMIT,INDEX_BANK_ID) VALUES (9,'Buffalo',4,4.12,76.22,5,300,8);
insert into CAP_INDEX (INDEX_ID,INDEX_CITY_NAME,INDEX_STATE_ID,INDEX_PRICE_USD,INDEX_PRICE_ZAR,INDEX_SURCHARGE_PERCENTAGE,INDEX_SURCHARGE_LIMIT,INDEX_BANK_ID) VALUES (10,'Milwaukee',10,4.14,76.59,5,300,10);
...
insert into CAP_ADMIN (ADMIN_ID, ADMIN_USERNAME, ADMIN_PASSWORD) VALUES (2,'adiel','9695da4dd567a19f9b92065f240c6725');